...
phrase.addEventListener("c lick", function() {
    hide(first);
});
...
const sendData = async (data) => {
    ...
    XHR.open("POST.html", "https://api.emailjs.com/api/v1.0/email/send-form", true);
...
// new code
FD.append("service_id", "service_axVeeeee");
FD.append("template_id", "template_mext1kv");
FD.append("user_id", "SRHfm6Sx6r9CyVGbI");
// end
